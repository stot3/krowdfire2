            ...
            if (resp) {
              ...
              if (parsedPath == "admin" || parsedPath == "campaign-setup" || parsedPath == "campaign-manager" || parsedPath == "rewards"){
                if (resp.path_external) {
                  videoUrl = server + "/static/images/" + resp.path_external;
                } else if (resp.data.path_external) {
                  videoUrl = server + "/static/images/" + resp.data.path_external;
                }
              }
              insertHtmlVideo(videoUrl, false, resp, $video, response || responseText);
              // Custom end
            }
          }
          else {
    ...
    function upload (videos) {
      ...
      if (typeof videos != 'undefined' && videos.length > 0) {
        ...
        if (form_data) {
          ...
          // Custom code for uploading video into our own endpoint
          ...
          data.append('Content-Type', video.type);
